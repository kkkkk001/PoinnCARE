...
class LinearDecoder(Decoder):
    ...
    def __init__(self, c, args, special_in_dim=None): #args.manifold, args.dim, args.n_classes, args.dropout, args.bias
        super(LinearDecoder, self).__init__(c)
        self.manifold = getattr(manifolds, args.manifold)()
        self.input_dim = args.dim if special_in_dim is None else special_in_dim
    ...
    def decode(self, x, adj):
        ...
        return self.decode_super(h, adj)

    def decode_super(self, x, adj):
